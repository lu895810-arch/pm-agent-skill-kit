...
Compatible with any coding agent that supports skills. For agents that read from `.workbuddy/skills/` (like [WorkBuddy](https://docs.anthropic.com/en/docs/claude-code) and [OpenCode](https://github.com/nicepkg/OpenCode)), just drop it in and go.
...
Clone or download this repo, then copy it into your project's `.workbuddy/skills/` directory:

```bash
git clone https://github.com/coleam00/excalidraw-diagram-skill.git
cp -r excalidraw-diagram-skill .workbuddy/skills/excalidraw-diagram
```
