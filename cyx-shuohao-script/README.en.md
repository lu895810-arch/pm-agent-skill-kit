...
```
cyx-shuohao-outline    → outline.json (what)
cyx-shuohao-characters → cast.json    (who)
cyx-shuohao-art        → art.json     (where + what's in their hands)
