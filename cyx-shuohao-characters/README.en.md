...
```
/cyx-shuohao-characters ./book.txt --lang en
/cyx-shuohao-characters ./book.txt --lang ja
```
...
```
cyx-shuohao-outline    → outline.json (what: structure & episodes, who is in)
cyx-shuohao-characters → cast.json    (who: character assets)
```
...
```
/cyx-shuohao-characters ./your-novel.txt
```
...
```
/cyx-shuohao-characters ./book.txt --style ghibli
```
