...
## Relationship to cyx-shuohao-characters

cyx-shuohao-outline owns adaptation structure (cutting, merging, beat placement, episodes); cyx-shuohao-characters owns character design (profiles, image/voice prompts, model sheets).
